...
mvn clean install -f ./hotels-service
docker build -t varindersingh6885/nagpbookingsystem_hotels-service ./hotels-service
docker push varindersingh6885/nagpbookingsystem_hotels-service